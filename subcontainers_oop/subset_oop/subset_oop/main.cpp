...
int main()
{
	...
	cout << "cur height " << sn.get_height() << endl;
	cout << "cur size " << sn.get_size() << endl;

	cout << endl;

	cout << "deleted 5? " << sn.remove(5) << endl;
	cout << "cur height " << sn.get_height() << endl;
	cout << "cur size " << sn.get_size() << endl;

	cout << endl;

	cout << "deleted 4? " << sn.remove(0) << endl;
	cout << "cur height " << sn.get_height() << endl;
	cout << "cur size " << sn.get_size() << endl;

	cout << endl;

	cout << "deleted 0? " << sn.remove(0) << endl;
	cout << "cur height " << sn.get_height() << endl;
	cout << "cur size " << sn.get_size() << endl;
