...
int main()
{
    //--------------SUBVECTOR FOR STRING ---------------------
    subvector<string> sv_s;
    sv_s.push_back("abc");
    sv_s.push_back("def");
    sv_s.push_back("ghi");
    ...
    cout << sv_s[1] << endl;
    sv_s.resize(5);
    cout << sv_s.get_cap() << endl;
    cout << endl;


    //-----------------SUBVECTOR FOR DOUBLE--------------------
    subvector<double> sv_d;
    sv_d.push_back(0.001);
    sv_d.push_back(0.1);
    sv_d.push_back(1.1);
    cout << sv_d.pop_back() << endl;
    cout << sv_d[1] << endl;
    sv_d.resize(5);
    cout << sv_d.get_cap() << endl;
